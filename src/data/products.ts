...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: "JBL Caixa de Som, Boombox 3, Bluetooth, À Prova D'água e Poeira - Preto",
    shortName: "JBL Boombox 3",
    category: "caixa-som",
    categoryIcon: Speaker,
    description: "JBL Boombox 3 com potentes 130W RMS e até 24 horas de bateria. Certificação IP67 à prova d'água e poeira, Bluetooth 5.3 LE e powerbank integrado para carregar dispositivos. Graves profundos e JBL Pro Sound para eventos e apresentações de impacto.",
    features: [
      "130W RMS de potência",
      "Até 24 horas de bateria",
      "IP67 à prova d'água e poeira",
      "Bluetooth 5.3 LE",
      "Powerbank integrado",
      "Graves profundos massivos"
    ],
    specifications: {
      "Marca": "JBL",
      "Modelo": "Boombox 3",
      ...
      "Bluetooth": "5.3 LE",
      "À Prova D'Água/Poeira": "IP67",
      "Powerbank": "USB para carregar dispositivos",
      "Drivers": "3-way speaker system",
      "Dimensões": "482.4 x 256.9 x 199.7 mm",
      "Peso": "6.7kg",
      "Alça": "Integrada robusta",
      "Cor": "Preto",
      "App": "JBL Portable",
      "Garantia": "12 meses"
    },
